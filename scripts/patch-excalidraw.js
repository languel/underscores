  ...
  if (fs.existsSync(target)) {
    ...
    content = content
      ...
      .replace(
        ...
        'path.getStrokeOutline((Number.parseFloat(getComputedStyle(this.container).getPropertyValue("--underscore-laser-width")) || (Number(this.app.state.currentItemStrokeWidth) || 1) * 4.25) / 2 / this.app.state.zoom.value)'
      )
      .replace(
      ...
      .replace(
        ...
        'e.getStrokeOutline((Number.parseFloat(getComputedStyle(this.container).getPropertyValue("--underscore-laser-width"))||(Number(this.app.state.currentItemStrokeWidth)||1)*4.25)/2/this.app.state.zoom.value)'
      )
      .replace(
