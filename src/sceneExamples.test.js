...
import { parseUnderscoresExchange } from "./sceneExchange.js";
...
test("glissandi example is a portable six-track continuous-trigger scene", () => {
  const { payload, score, grid, expressiveSynth, mixer } = parseUnderscoresExchange(readExample("glissandi.json"), "scene");
