...
export const MIXER_STORAGE_KEY = "drawerator_mixer_v1";
...
const destinationFromLegacyOutput = legacyOutputId => {
  ...
  if (legacyOutputId === "__drawerator_expressive_synth__") return { destination: MIXER_DESTINATION_INTERNAL, instrument: MIXER_INSTRUMENT_EXPRESSIVE };
