...
test("source element predicate excludes derived streams", () => {
  const camera = { customData: { underscoreMediaStream: createMediaStreamConfig("camera") } };
  const canvas = { customData: { underscoreMediaStream: createMediaStreamConfig("canvas") } };
  const holistic = { customData: { underscoreMediaStream: createMediaStreamConfig("holistic") } };
  const preview = { customData: { underscoreMediaStream: createMediaStreamConfig("preview") } };
...
test("holistic rectangle hosts remain valid object-bounds targets", () => {
  ...
  const holistic = { id: "holistic", type: "rectangle", customData: { underscoreMediaStream: createMediaStreamConfig("holistic") } };
  const preview = { id: "preview", type: "rectangle", customData: { underscoreMediaStream: createMediaStreamConfig("preview") } };
  const camera = { id: "camera", type: "rectangle", customData: { underscoreMediaStream: createMediaStreamConfig("camera") } };
...
test("canvas visibility hides only the optional stream view", () => {
  ...
  const visible = { opacity: 100, customData: { underscoreMediaStream: config } };
