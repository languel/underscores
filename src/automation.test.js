...
test("auto-key records changed core and Drawerator fields", () => {
  ...
  assert.equal(keyed.customData.draweratorAutomation.tracks.x[0].value, 20);
  assert.equal(keyed.customData.draweratorAutomation.tracks["customData.modifiers"][0].interpolation, "step");
