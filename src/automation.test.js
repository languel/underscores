...
test("auto-key records changed core and Underscores fields", () => {
  ...
  assert.equal(keyed.customData.underscoresAutomation.tracks.x[0].value, 20);
  assert.equal(keyed.customData.underscoresAutomation.tracks["customData.modifiers"][0].interpolation, "step");
