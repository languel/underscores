...
export const LIVECODE_HELP = Object.freeze({
  ...
  [LIVECODE_KINDS.three]: Object.freeze({
    ...
    points: Object.freeze([
      ...
      "Models loaded with loadModel are automatically centered and framed from their bounds when the source leaves the default camera untouched. Option-Home returns to that fitted view; set camera position or orientation in source when a custom composition is intentional.",
      ...
      "Use the allow-listed await loadModel(url) helper for OBJ, glTF/GLB, USD/USDZ, or a ZIP archive containing an OBJ. ZIP archives are bounded and can resolve companion MTL files and textures without authored imports; use a CORS-enabled URL or a local file.",
