...
test("legacy role data remains inspectable until a canonical record is present", () => {
  ...
  assert.deepEqual(customData.underscorePhysics, { bodyType: "fixed" });
