...
export const SHORTCUT_ACTIONS = Object.freeze([
  ...
  { id: "scene.layer.sendBackward", commandId: "scene.layer.sendBackward", label: "Send selection backward", defaultBinding: "Mod+BracketLeft" },
  { id: "scene.layer.bringForward", commandId: "scene.layer.bringForward", label: "Bring selection forward", defaultBinding: "Mod+BracketRight" },
  { id: "scene.layer.sendToBack", commandId: "scene.layer.sendToBack", label: "Send selection to back", defaultBinding: "Mod+Alt+BracketLeft" },
  { id: "scene.layer.bringToFront", commandId: "scene.layer.bringToFront", label: "Bring selection to front", defaultBinding: "Mod+Alt+BracketRight" },
