...
- **Scriptable Brushes:** Edit, import, rename, fork, or apply brush JavaScript in the standalone **Script** panel. The Run action applies the active brush draft to selected freehand or line paths. See [Custom brushes](notes/custom-brushes.md) for the authoring guide.
