...
Run `/physics demo marionette`. The head, body, and arms are normal selectable Underscore objects. A fixed world pin supports the head; a damped spring forms the neck; revolute joints connect the arms.
