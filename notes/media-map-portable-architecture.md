...
> A language- and tracker-independent specification for reproducing Underscores's Media Map philosophy, interaction model, stream processing, event authoring, and system mappings.
...
## 21. Underscores implementation correspondence (non-normative)

These files are useful when comparing the reference architecture with the current implementation:

| Responsibility | Underscores implementation |
| --- | --- |
